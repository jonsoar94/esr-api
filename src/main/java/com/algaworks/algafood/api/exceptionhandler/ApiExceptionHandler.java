...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleValidacaoException(ValidacaoException ex, HttpStatus status, WebRequest request) {
        return handleValidacaoException(ex, status, request);
    }

    // Method responsible to handle exceptions when validation of bean with @Valid
    // fails.
    @Override
    ...
    // method responsible to handle all the other errors
    ...
    // method responsible to handle when resource is not available.
    @Override
    ...
    // method responsible to handle type mistach errors
    @Override
    protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
            HttpStatus status, WebRequest request) {

        // check if the method argument type match. If no, wrong format as URL parameter
        // was sent.
        ...
        return super.handleTypeMismatch(ex, headers, HttpStatus.OK, request);
    }
    ...
    // handle json format invalid error
    @Override
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        // check if invalid forma exception
    ...
    // method responsible to handle the property binding exception, when informed
    ...
    private ResponseEntity<Object> handlePropertyBindingException(PropertyBindingException ex, HttpHeaders headers,
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format("A propriedade '%s' não existe. Corrija e informa um valor correto.", path);
        Problem problem = createProblemBuilder(status, problemType, detail).userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
                .build();
    ...
    // method responsible to handle the invalid format exception, when input is
    // wrong as expected.
    ...
    // generic method to handle validation of not valid parameters
